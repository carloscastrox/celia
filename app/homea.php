...
if (isset($_SESSION['user']) && isset($_SESSION['rol'])) {
    $login = $conn->prepare("SELECT * FROM user WHERE email = ? AND rol = ?");
    $login->bindParam(1, $_SESSION['user']);
    $login->bindParam(2, $_SESSION['rol']);
    $login->execute();
...
?>
        ...
        <body class="h-100">
                    ...
                    <div class="container-fluid">
                        ...
                        <div class="collapse navbar-collapse" id="collapsibleNavbar">
                            <ul class="navbar-nav me-auto">
                                <li class="nav-item">
                                    <a class="nav-link" href="./homea">Inicio</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" href="?page=pubs">Publicaciones</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" href="?page=adm_tableusers">Usuarios</a>
                                </li>
                            </ul>
                            <div class="d-flex">
                                <?php echo $result['fname'] . " " . $result['lname']; ?>
                                <a href="?page=profilea" class="btn btn-warning">Perfil</a>
            ...
            <main class="container pt-5 mt-5">
                ...
                $page = isset($_GET['page']) ? strtolower($_GET['page']) : 'homea';
